...
def _defaultbackend(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/qsub/private/defaultbackend.m )
    ...
    return Runtime.call("defaultbackend", *args, **kwargs)
