...
def _cluster_ward(*args, **kwargs):
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/private/cluster_ward.m )
    ...
    return Runtime.call("cluster_ward", *args, **kwargs)
