...
def ft_spiketriggeredspectrum_convol(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spiketriggeredspectrum_convol.m )
    ...
    return Runtime.call("ft_spiketriggeredspectrum_convol", *args, **kwargs)
