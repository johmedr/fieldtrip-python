...
def ft_spike_isi(*args, **kwargs):
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spike_isi.m )
    ...
    return Runtime.call("ft_spike_isi", *args, **kwargs)
