...
def ft_spike_xcorr(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spike_xcorr.m )
    ...
    return Runtime.call("ft_spike_xcorr", *args, **kwargs)
