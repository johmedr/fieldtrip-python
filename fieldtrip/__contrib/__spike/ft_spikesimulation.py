...
def ft_spikesimulation(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spikesimulation.m )
    ...
    return Runtime.call("ft_spikesimulation", *args, **kwargs)
