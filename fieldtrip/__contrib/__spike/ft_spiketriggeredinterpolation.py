...
def ft_spiketriggeredinterpolation(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spiketriggeredinterpolation.m )
    ...
    return Runtime.call("ft_spiketriggeredinterpolation", *args, **kwargs)
