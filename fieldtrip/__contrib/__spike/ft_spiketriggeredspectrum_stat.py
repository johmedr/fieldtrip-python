...
def ft_spiketriggeredspectrum_stat(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/spike/ft_spiketriggeredspectrum_stat.m )
    ...
    return Runtime.call("ft_spiketriggeredspectrum_stat", *args, **kwargs)
