...
def ft_nonlinearassociation(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/misc/ft_nonlinearassociation.m )
    ...
    return Runtime.call("ft_nonlinearassociation", *args, **kwargs)
