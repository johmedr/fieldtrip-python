...
def nmt_sourceplot(*args, **kwargs):
    """
      NMT_SOURCEPLOT
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/nutmegtrip/nmt_sourceplot.m )
    ...
    return Runtime.call("nmt_sourceplot", *args, **kwargs, nargout=0)
