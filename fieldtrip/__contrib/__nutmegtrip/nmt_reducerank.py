...
def nmt_reducerank(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/nutmegtrip/nmt_reducerank.m )
    ...
    return Runtime.call("nmt_reducerank", *args, **kwargs)
