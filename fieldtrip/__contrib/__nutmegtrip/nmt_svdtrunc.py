...
def nmt_svdtrunc(*args, **kwargs):
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/nutmegtrip/nmt_svdtrunc.m )
    ...
    return Runtime.call("nmt_svdtrunc", *args, **kwargs)
