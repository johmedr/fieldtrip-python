...
def nmt_transform_coord(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/nutmegtrip/nmt_transform_coord.m )
    ...
    return Runtime.call("nmt_transform_coord", *args, **kwargs)
