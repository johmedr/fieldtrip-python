...
def nmt_tbxdti_quiver3(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/contrib/nutmegtrip/nmt_tbxdti_quiver3.m )
    ...
    return Runtime.call("nmt_tbxdti_quiver3", *args, **kwargs)
