...
def _physionet_hea(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/fileio/private/physionet_hea.m )
    ...
    return Runtime.call("physionet_hea", *args, **kwargs)
