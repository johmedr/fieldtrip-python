...
def _get_degrees_orders(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/private/get_degrees_orders.m )
    ...
    return Runtime.call("get_degrees_orders", *args, **kwargs)
