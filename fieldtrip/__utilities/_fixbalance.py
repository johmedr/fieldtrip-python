...
def _fixbalance(*args, **kwargs):
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/utilities/private/fixbalance.m )
    ...
    return Runtime.call("fixbalance", *args, **kwargs)
