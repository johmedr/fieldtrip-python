...
def ft_inverse_montage(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/utilities/ft_inverse_montage.m )
    ...
    return Runtime.call("ft_inverse_montage", *args, **kwargs)
