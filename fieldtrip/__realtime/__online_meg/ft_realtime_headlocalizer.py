...
def ft_realtime_headlocalizer(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_meg/ft_realtime_headlocalizer.m )
    ...
    return Runtime.call("ft_realtime_headlocalizer", *args, **kwargs, nargout=0)
