...
def _midiOut(*args, **kwargs):
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_eeg/private/midiOut.m )
    ...
    return Runtime.call("midiOut", *args, **kwargs)
