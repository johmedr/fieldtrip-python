...
def ft_omri_info_from_header(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_info_from_header.m )
    ...
    return Runtime.call("ft_omri_info_from_header", *args, **kwargs)
