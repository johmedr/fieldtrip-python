...
def ft_omri_pipeline(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_pipeline.m )
    ...
    return Runtime.call("ft_omri_pipeline", *args, **kwargs, nargout=0)
