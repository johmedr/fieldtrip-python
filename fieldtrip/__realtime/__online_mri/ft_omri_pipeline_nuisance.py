...
def ft_omri_pipeline_nuisance(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_pipeline_nuisance.m )
    ...
    return Runtime.call("ft_omri_pipeline_nuisance", *args, **kwargs, nargout=0)
