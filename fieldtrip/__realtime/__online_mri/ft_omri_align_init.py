...
def ft_omri_align_init(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_align_init.m )
    ...
    return Runtime.call("ft_omri_align_init", *args, **kwargs)
