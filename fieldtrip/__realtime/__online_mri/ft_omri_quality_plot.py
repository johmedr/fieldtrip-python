...
def ft_omri_quality_plot(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_quality_plot.m )
    ...
    return Runtime.call("ft_omri_quality_plot", *args, **kwargs, nargout=0)
