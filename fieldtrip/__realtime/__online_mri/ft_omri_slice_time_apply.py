...
def ft_omri_slice_time_apply(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/online_mri/ft_omri_slice_time_apply.m )
    ...
    return Runtime.call("ft_omri_slice_time_apply", *args, **kwargs)
