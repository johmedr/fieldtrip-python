...
def ft_realtime_asaproxy(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_asaproxy.m )
    ...
    return Runtime.call("ft_realtime_asaproxy", *args, **kwargs, nargout=0)
