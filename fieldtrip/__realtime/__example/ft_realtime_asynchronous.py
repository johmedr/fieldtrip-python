...
def ft_realtime_asynchronous(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_asynchronous.m )
    ...
    return Runtime.call("ft_realtime_asynchronous", *args, **kwargs)
