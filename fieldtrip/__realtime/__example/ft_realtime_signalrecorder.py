...
def ft_realtime_signalrecorder(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_signalrecorder.m )
    ...
    return Runtime.call("ft_realtime_signalrecorder", *args, **kwargs, nargout=0)
