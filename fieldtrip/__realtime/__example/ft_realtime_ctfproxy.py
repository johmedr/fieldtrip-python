...
def ft_realtime_ctfproxy(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_ctfproxy.m )
    ...
    return Runtime.call("ft_realtime_ctfproxy", *args, **kwargs, nargout=0)
