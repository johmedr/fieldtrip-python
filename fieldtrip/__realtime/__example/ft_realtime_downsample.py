...
def ft_realtime_downsample(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_downsample.m )
    ...
    return Runtime.call("ft_realtime_downsample", *args, **kwargs, nargout=0)
