...
def ft_realtime_benchmark(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_benchmark.m )
    ...
    return Runtime.call("ft_realtime_benchmark", *args, **kwargs)
