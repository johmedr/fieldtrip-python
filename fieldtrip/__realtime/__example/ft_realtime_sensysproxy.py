...
def ft_realtime_sensysproxy(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_sensysproxy.m )
    ...
    return Runtime.call("ft_realtime_sensysproxy", *args, **kwargs, nargout=0)
