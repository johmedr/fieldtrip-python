...
def ft_realtime_unicornproxy(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_unicornproxy.m )
    ...
    return Runtime.call("ft_realtime_unicornproxy", *args, **kwargs, nargout=0)
