...
def ft_realtime_signalviewer(*args, **kwargs):
    """
    ...
    [Matlab code]( https://github.com/fieldtrip/fieldtrip/blob/master/realtime/example/ft_realtime_signalviewer.m )
    ...
    return Runtime.call("ft_realtime_signalviewer", *args, **kwargs, nargout=0)
